...
/*   Updated: 2023/07/11 17:19:40 by jaiveca-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_energy > 0 && this->_hp > 0)
	{
		...
		// if (this->_hp > 10)
		// 	this->_hp = 10;
		std::cout << this->_name << " has healed " << amount 
			<< " hit points. It has " << this->_hp << " hit points left." << std::endl;
		this->_energy--;		
	}
	else if (this->_energy <= 0)
		std::cout << this->_name << " has no energy points left, it cannot repair itself!" << std::endl;
	else
		std::cout << this->_name << " has no hit points left, it cannot repair itself!" << std::endl;	
}